...
export class MachinesV2ToV3 {
  ...
  static insertDefaultMachineType = this.db
    .prepare(`INSERT INTO machine_types (machine_type_id, name, maximum_diameter, registration_time, last_update_time)
  ...
  static renameMachinesTableToOldMachines = this.db
    .prepare(`ALTER TABLE machines
    RENAME TO old_machines;
    `);

  static insertOldMachineToMachines = this.db
    .prepare(`INSERT INTO machines (id, machine_id, machine_type_id, name, registration_time, last_update_time)
