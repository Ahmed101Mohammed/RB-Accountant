...
ipcMain.handle(
  "createAccountsGroup",
  (event, entityId, name, accountsGroupId) => {
...
ipcMain.handle(
  "getAccountsGroupsByEntityIdContains",
  (event, partialId, page, pageSize) => {
    let response = AccountsGroups.getAccountsGroupsByEntityIdContains(
      partialId,
      page,
      pageSize
    );
...
ipcMain.handle(
  "getAccountsGroupsByNameContains",
  (event, partialName, page, pageSize) => {
    let response = AccountsGroups.getAccountsGroupsByNameContains(
      partialName,
      page,
      pageSize
    );
