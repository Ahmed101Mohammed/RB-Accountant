...
import { AccountsGroup as AccountsGroupEntity } from "../entities/AccountsGroup.js";
...
export class AccountsGroups {
  static create(entityId, name, accountsGroupId) {
    ...
    if (FinancialRepresentativeEntity.isNameUnique(name) === false)
      return new Response(
        false,
        "اسم تبويب الحسابات مستخدم من قبل، استخدم اسم جديد"
      );
    ...
    const lightAccountsGroup = new LightAccountsGroup(
      entityId,
      name,
      accountsGroupId
    );
    ...
    try {
      ...
      return new Response(
        false,
        "فشل انشاء تبويب الحسابات: " + error.message,
        null
      );
    }
  }
  ...
  static update(id, { entityId, name, accountsGroupId }) {
    ...
    if (
      accountsGroupId !== undefined &&
      AccountsGroups.isAccountGroupIdChildOfAccountsGroupId(
        accountsGroupId,
        id
      ) === true
    )
      return new Response(
        false,
        "لا يمكن لتبويب حسابات أن يتفرع من تبويب آخر متفرع منه، أو تبويب متفرع من فروعه"
      );

    if (accountsGroupId === undefined) accountsGroupId = null;

    // Create AccountsGroup entity
    const accountsGroup = new AccountsGroupEntity(
      id,
      entityId,
      name,
      accountsGroupId
    ...
    try {
      ...
      return new Response(
        false,
        "فشل تحديث تبويب الحسابات: " + error.message,
        null
      );
    }
  }
  ...
  static delete(id) {
    // Data Validations
    const deleteSchema = AccountsGroupEntity.idSchema;
    ...
    try {
      ...
      return new Response(
        false,
        "فشل حذف تبويب الحسابات: " + error.message,
        null
      );
    }
  }
  ...
  static getAccountsGroups(page, pageSize) {
    ...
    try {
      ...
      return new Response(
        true,
        "تم الحصول على تبويبات الحسابات بنجاح",
        response
      );
    } catch (error) {
      return new Response(
        false,
        "فشل الحصول على تبويبات الحسابات: " + error.message,
        null
      );
    }
  }
  ...
  static getAccountsGroupById(id) {
    // Data Validations
    const getSchema = AccountsGroupEntity.idSchema;
    ...
    try {
      ...
      return new Response(
        false,
        "فشل الحصول على تبويب الحسابات: " + error.message,
        null
      );
    }
  }
  ...
  static getAccountsGroupsByEntityIdContains(partialEntityId, page, pageSize) {
    ...
    // Get
    try {
      const response = AccountsGroupsModel.getAccountsGroupsByEntityIdContains(
        partialEntityId,
        page,
        pageSize
      );
  ...
  static getAccountsGroupsByNameContains(partialName, page, pageSize) {
    ...
    // Get
    try {
      const response = AccountsGroupsModel.getAccountsGroupsByNameContains(
        partialName,
        page,
        pageSize
      );
